...
export default function ControlBar() {
    ...
    return (
        <div className="bg-gray-800 flex space-x-4 justify-center py-3 fixed bottom-0 left-0 right-0">
            ...
            <div className="bg-gray-700 text-gray-300 hover:bg-gray-600 hover:text-white px-3 py-2 rounded-md text-sm font-medium" onClick={() => {dispatch(toggleDeafened()); dispatch(toggleMuted())}}>Deafen</div>
            <div className="bg-gray-700 text-gray-300 hover:bg-gray-600 hover:text-white px-3 py-2 rounded-md text-sm font-medium" onClick={() => dispatch(showSidebarParticipants())}>Participants</div>
            <div className="bg-gray-700 text-gray-300 hover:bg-gray-600 hover:text-white px-3 py-2 rounded-md text-sm font-medium" onClick={() => dispatch(showSidebarChat())}>Chat</div>
